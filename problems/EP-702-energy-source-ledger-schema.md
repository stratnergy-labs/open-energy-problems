...
# Energy Source-Ledger Schema

## Problem

Standard record of source, query, timestamp, licence, result count, hash, and limitations.
...
This is a schema problem first; examples should avoid copying restricted source data.
